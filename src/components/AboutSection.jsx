...
export const AboutSection = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: "https://linkedin.com/in/esraa-ashraf-aaa5962a4",
    },
    {
  ...
  const tabContent = {
    personal:
      "React Developer passionate about building clean and user-friendly interfaces. I enjoy turning complex ideas into simple, practical web solutions.",

    professional:
      "React Developer with 2+ years of experience working on real-world web applications and dashboards. I’ve contributed to company projects and production systems using React and REST APIs.",

    approach:
      "I focus on clean component structure, responsive design, and smooth API integration. I enjoy working in teams and building scalable front-end solutions.",
  };
  ...
  const handleDownload = () => {
    ...
    link.href = "/Esraa_Ashraf_Cv.pdf";
    link.download = "Esraa_Ashraf_CV.pdf";
