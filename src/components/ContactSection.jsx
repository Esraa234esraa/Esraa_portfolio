...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xqearwdb", {
        method: "POST",
        headers: {
      ...
      toast({
        ...
        description:
          "Please try again or email me directly at esraaashraf2213@gmail.com",
        variant: "destructive",
      });
    } finally {
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/esraa-ashraf-aaa5962a4",
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/Esraa234esraa",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
