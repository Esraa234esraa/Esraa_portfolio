...
export const HeroSection = () => {
  ...
  const codeSnippets = [
    "import { ReactDeveloper } from 'esraa.dev';",
    "",
    "const developer = new ReactDeveloper({",
    "  name: 'Esraa Ashraf',",
    "  role: 'React Developer',",
    "  stack: ['React', 'JavaScript', 'Tailwind', 'REST APIs'],",
    "  focus: 'Building real-world dashboards & web apps',",
    "  status: 'Open to remote opportunities'",
    "});",
    "",
    "await developer.buildPortfolio();",
    "// Projects: Dashboards, POS Systems, Business Websites",
    "",
    "developer.connect();",
  ...
  const handleViewResume = () => {
    ...
    window.open("/Esraa_Ashraf_Cv.pdf", "_blank", "noopener,noreferrer");
  };
      ...
      <div className="container max-w-7xl mx-auto w-full mt-16 sm:mt-0">
        ...
        >
          <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            ...
            >
              <span className="block text-foreground">I'm Esraa Ashraf</span>
              <motion.span className="block bg-gradient-to-r from-primary via-purple-600 to-pink-600 bg-clip-text text-transparent mt-2">
                React Developer
              </motion.span>
            </motion.h1>
            ...
            >
              ...
              and dashboards using React. Specialized in responsive UI, clean
              component structure, and seamless API integration for business
              systems.
            </motion.p>
