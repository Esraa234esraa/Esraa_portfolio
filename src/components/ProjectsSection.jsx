...
const projects = [
  ...
  {
    id: 1,
    title: "CoffeeCo – Cashier Dashboard",
    category: "Professional Projects",
    description:
      "React-based cashier dashboard used for managing orders, daily sales, and in-store operations.",
    image: "/projects/coffeco-cashier.png",
    video: null,
    tags: ["React", "Dashboard", "REST API"],
    demoUrl: "https://cashier.coffeco.top/",
    githubUrl: "#",
    featured: true,
  ...
  {
    id: 2,
    title: "CoffeeCo – Business Website",
    category: "Professional Projects",
    description:
      "Responsive business website built with React to present CoffeeCo brand, services, and locations.",
    image: "/projects/coffeco-website.png",
    video: null,
    tags: ["React", "Responsive UI"],
    demoUrl: "https://coffeco.top/",
    githubUrl: "#",
    featured: true,
  ...
  {
    id: 3,
    title: "ILC Training Platform",
    category: "Professional Projects",
    description:
      "Educational platform built with React featuring dynamic content and responsive layouts.",
    image: "/projects/ilc.png",
    video: null,
    tags: ["React", "Education Platform", "API Integration"],
    demoUrl: "https://www.ilc-training.com/",
    githubUrl: "#",
    featured: true,
  ...
  // =========================
  {
    ...
    description:
      "Fully functional e-commerce website built with React and Tailwind CSS.",
    image: "/projects/ecommerce.png",
    video: null,
    tags: ["React", "Tailwind", "Local Storage"],
    demoUrl: "https://e-commerce-1dmn.vercel.app/",
    githubUrl: "https://github.com/Esraa234esraa",
    featured: false,
  ...
  {
    id: 5,
    title: "Famous Dishes by Country",
    category: "Personal Projects",
    description:
      "Web application displaying famous dishes from different countries using a public API.",
    image: "/projects/yumm.png",
    video: null,
    tags: ["JavaScript", "API", "Bootstrap"],
    demoUrl: "https://esraa234esraa.github.io/Yumm/",
    githubUrl: "https://github.com/Esraa234esraa/Yumm",
    featured: false,
        ...
        >
          <div className="bg-background border border-border rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              I’m open to React and Frontend opportunities, including
              dashboards, business websites, and production-ready applications.
            </p>
