...
const skills = [
  ...
  // APIs & State
  { name: "REST APIs", level: 85, category: "api", icon: "javascript" },
  { name: "Axios", level: 85, category: "api", icon: "javascript" },
  { name: "Postman", level: 80, category: "api", icon: "javascript" },
  ...
  // Databases (Basic)
  { name: "SQL Server", level: 70, category: "database", icon: "sql" },
  { name: "MySQL", level: 70, category: "database", icon: "mysql" },
];
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            React-focused skills used in real production projects
          </p>
        </motion.div>
